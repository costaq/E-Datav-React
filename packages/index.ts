...
export type { DigitalFlopProps } from './components/digitalFlop';
export type { BorderBox1Props } from './components/border-box-1';
...
export { default as BorderBox1 } from './components/border-box-1';
