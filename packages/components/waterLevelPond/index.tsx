 ...
 * @LastEditors: costa
 * @LastEditTime: 2023-07-12 14:37:02
 * @Description: 水位图
...
const WaterLevelPond: React.FC<WaterLevelPondProps> = (props) => {
    ...
    return <BoxContainer className='e-water-level-pond' $height={style?.height} $width={style?.width} $fontSize={fontSize} $fontColor={fontColor} $backgroundColor={backgroundColor}>
